...
public class Preferencia {
    ...
    public Preferencia(String nif, Aspirant aspirant, Especialitat especialitat, Centre centre, int ordre) {
        this.nif = nif;
        this.ordre = ordre;
    ...
    public Preferencia(String nif, String idCos, String idEspecialitat, String idCentre, int ordre) {}
